 ...
 * @author Adrian
 */
public class FrmMiembrosComiteCambios extends javax.swing.JFrame {

    /**
     * Creates new form Miembros_Comite_Cambios
     */
    public FrmMiembrosComiteCambios() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMiembrosComiteCambios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMiembrosComiteCambios().setVisible(true);
            }
        });
    }
