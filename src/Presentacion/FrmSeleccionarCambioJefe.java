 ...
 * @author Usuario
 */
public class FrmSeleccionarCambioJefe extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public FrmSeleccionarCambioJefe() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSeleccionarCambioJefe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSeleccionarCambioJefe().setVisible(true);
            }
        });
    }
