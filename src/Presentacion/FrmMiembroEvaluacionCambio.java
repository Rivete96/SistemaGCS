 ...
 * @author Adrian
 */
public class FrmMiembroEvaluacionCambio extends javax.swing.JFrame {

    /**
     * Creates new form Miembro_Evaluacion_Cambio
     */
    public FrmMiembroEvaluacionCambio() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMiembroEvaluacionCambio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMiembroEvaluacionCambio().setVisible(true);
            }
        });
    }
